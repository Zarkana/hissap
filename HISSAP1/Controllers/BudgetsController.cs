...
namespace HISSAP1.Controllers
{
    public class BudgetsController : MyBaseController
    {
        ...
        public ActionResult Create(int? id)
        {
            ...
            //Reset primary ID's for children objects
            foreach (var item in CopiedBudget.PayrollTaxesAssessment.PayrollItems)
            {
        ...
        public ActionResult Edit([Bind(Include = "Id,BudgetsSiteId,DateCreated,ContractNumber,BudgetStatus,UnemploymentInsuranceState,UnemploymentInsuranceFederal,TotalContractAmount,TotalExpenses,Salary,PersonnelCost")] Budget model)
        {
            ...
            //TODO: add the rest of the budget model data
